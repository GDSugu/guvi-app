...
const {findAll,findById,insert,updateById,deleteById} = require("../helpers/post.helpers")
...
module.exports = {
    ...
    async create(req,res){
        ...
        try {
                    ...
                    // const post  = await insert(req.body,req.user._id);
                    // res.json({ message: "Posts created successfully",post });
...
// eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2MjhlZDdkNDA0YjhjZmYwOTgzMjc1ZjQiLCJpYXQiOjE2NTM1Mjg3OTgsImV4cCI6MTY1MzUzMjM5OH0.hhIRnFFSQD-J7q_AEj5Ctm2MaftbtNEiSMo1xDcWfqc

//eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2MjhlZDdhZDA0YjhjZmYwOTgzMjc1ZjMiLCJpYXQiOjE2NTM1MzAxMzYsImV4cCI6MTY1MzUzMzczNn0.o3dfhio9IOAp7Vz_tSomivtWx33Ew3JzUS12b2xOTeI